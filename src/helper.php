...
if (!function_exists('convert_weight')) {
    ...
    function convert_weight($weight, $fromUnit, $toUnit)
    {
        // 定义单位转换系数
        $conversionFactors = [
            'mg' => ['g' => 0.001, 'kg' => 0.000001, 't' => 0.000000001, 'mg' => 1],
            'g'  => ['mg' => 1000, 'kg' => 0.001, 't' => 0.000001, 'g' => 1],
            'kg' => ['mg' => 1000000, 'g' => 1000, 't' => 0.001, 'kg' => 1],
...
if (!function_exists('convert_dimension')) {
    ...
    function convert_dimension($dimension, $fromUnit, $toUnit)
    {
        // 定义单位转换系数
        $conversionFactors = [
            'mm' => ['cm' => 0.1, 'm' => 0.001, 'in' => 0.0393701, 'ft' => 0.00328084, 'mm' => 1],
            'cm' => ['mm' => 10, 'm' => 0.01, 'in' => 0.393701, 'ft' => 0.0328084, 'cm' => 1],
            'm'  => ['mm' => 1000, 'cm' => 100, 'in' => 39.3701, 'ft' => 3.28084, 'm' => 1],
            'in' => ['mm' => 25.4, 'cm' => 2.54, 'm' => 0.0254, 'ft' => 0.0833333, 'in' => 1],
